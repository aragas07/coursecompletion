                    ...
                    <div class="container-fluid">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title"><button data-toggle="modal" data-target="#upl-csv"
                                        class="btn btn-outline-secondary">Import grades via CSV</button></div>
                            ...
                            <div class="card-body">
                                <div class="tab-content p-0">
                                    ...
                                    <div class="col-md-12 row" id="info">
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" id="search" value="<?php echo $_GET['id']?>"
                                                        placeholder="Search" class="form-control form-control-sm">
                                                </div>
                                                <label class="col-sm-2 col-form-label">Birth date</label>
                                                <div class="col-sm-4">
                                                    <input type="text" id="birth" class="form-control form-control-sm"
                                                        disabled>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                    ...
                                    <div class="chart tab-pane" id="curriculum" style="position: relative">
                                        ...
                                        <button class="btn btn-danger" id="prospectus-send-email">Send prospectus to
                                            email</button>
                                    </div>
                                    <div class="chart tab-pane active row" id="grades" style="position: relative">
                                            ...
                                            <table class="table table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td>Sem</td>
                                                        <td>Subject
                                                            <input type="number" id="sub-num"
                                                                placeholder="Input number of subject (4)"
                                                                class="form-control right form-control-sm col-md-4">
                                                        </td>
                                                        <td>Final grades</td>
                                                    </tr>
                                                </thead>
                                        ...
                                        <button hidden class="btn btn-primary" id="submit-comp">Submit
                                            compliance</button>
                                        <button id="send-email-btn" class="btn btn-danger btn-rounded mb-4">Send Grades
                                            to Email</button>
                                        <input type="text" class="form-control right col-sm-2 form-control-sm"
                                            id="r-year" disabled>
                        ...
                        <form id="upcsv" enctype="multipart/form-data">
                            <div class="modal-body">
                                <div class="text-center">
                                    ...
                                    <p style="font-size: 19px">Student ID, Course no., Description, Year, Sem, Grades</p>
                                    <div class="border">
                                    </div>
                                    <div class="sample-data-title">
                                        <div class="img-title">Sample data format</div>
                                        <img src="assets/dist/img/sample_grade.png" alt="sdf" class="col-12">
                                    </div>
                                </div>
                                <input type="file" accept=".csv" class="form-control" name="gradesfile">
                            </div>
                ...
                $.ajax({
                    ...
                    success: function(latest) {
                        ...
                        if (b) {
                            ...
                            "Sorry, but you must fill out the input text area completely."
                            );
                    ...
                    success: function(result) {
                        ...
                        $(".select-sem").each(function(index) {
                            $(this).change(function() {
                                selectsub(subject, number, $(".select-year").eq(
                                    index).val(), $(this).val(), $(
                                    ".subject-cont").eq(index));
                                setInId();
                            })
                        })
                        $(".select-year").each(function(index) {
                            $(this).change(function() {
                                selectsub(subject, number, $(this).val(), $(
                                    ".select-sem").eq(index).val(), $(
                                    ".subject-cont").eq(index));
                                setInId();
                            })
                        })
                        $(".subject-cont").each(function(index) {
                            selectsub(subject, number, $(".select-year").eq(index).val(), $(
                                ".select-sem").eq(index).val(), $(this));
                        });
                        setInId();
                    }
                });
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        $(".edit-grades-btn").click(function() {
                            $(this).html('Save').attr('class',
                                'btn btn-primary mb-3 edit-grades-btn');
                            ...
                            if (c == $(this).attr('id') + true) {
                                $("." + $(this).attr('id')).each(function() {
                                    ...
                                    $(this).empty();
                                    $(this).append('<input type="text" id="' + $(
                                            this).attr('id') +
                                        '" style="width: 100px" class="inp' +
                                        btnid +
