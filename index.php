        ...
        <div class="content-wrapper">
            ...
            <div class="row" style="margin: 0px 10px 0px 10px;">
                ...
                <div class="col-12 col-sm-6 col-md-6">
                    <a href="enrollment.php?id=">
                        <div class="info-box mb-3" style="border: 3px solid #28a745">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Course Admission</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    </a>
                ...
                <div class="col-12 col-sm-6 col-md-12">
                    <a href="grades.php?id=">
                        <div class="info-box mb-3" style="border: 3px solid rgb(151, 151, 151)">
                            <span class="info-box-icon elevation-1" style="background-color: rgb(151, 151, 151)">
